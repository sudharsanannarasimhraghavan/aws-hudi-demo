...
sudo aws s3 cp s3://md-labs-hudi-demo-artifacts-bucket/hudi-demo/configs/dfs-source-retail-transactions-full.properties /home/hadoop/
sudo aws s3 cp s3://md-labs-hudi-demo-artifacts-bucket/hudi-demo/configs/dfs-source-retail-transactions-incremental.properties /home/hadoop/
sudo aws s3 cp s3://md-labs-hudi-demo-artifacts-bucket/hudi-demo/configs/base.properties s3://"${CFTS3Bucket}"/properties/
...
aws s3 cp s3://md-labs-hudi-demo-artifacts-bucket/hudi-demo/schema/source-full.avsc s3://"${CFTS3Bucket}"/schema/
aws s3 cp s3://md-labs-hudi-demo-artifacts-bucket/hudi-demo/schema/source-incremental.avsc s3://"${CFTS3Bucket}"/schema/
aws s3 cp s3://md-labs-hudi-demo-artifacts-bucket/hudi-demo/schema/target.avsc s3://"${CFTS3Bucket}"/schema/
